...
| 4        | **updateComicBooksJob**      | Performs a mass update of metadata for comics                                       |
| 5        | **markBlockedPagesJob**      | Marks blocked pages for deletion                                                    |
| 6        | **recreateComicFilesJob**    | Recreates selected comic files                                                      |
| 7        | **updateMetadataJob**        | Updates the metadata contained in or with comic files                               |
| 8        | **organizeLibraryJob**       | Organize the comic files                                                            |
