...
public class FileTypeAdaptor {
  ...
  public ContentAdaptor getContentAdaptorFor(
    ...
    ContentAdaptor result = this.contentAdaptorRegistry.getContentAdaptorForFilename(filename);
    if (result == null) {
      final String subtype = this.getSubtype(new ByteArrayInputStream(content));
      result = this.contentAdaptorRegistry.getContentAdaptorForContentType(subtype);
    }
    return result;
  }
  ...
  /**
   * Returns the entry type for the given content type.
   *
   * @param contentType the content type
   * @return the entry type
   */
  public ArchiveEntryType getArchiveEntryType(final String contentType) {
    final ContentAdaptor contentAdaptor =
        this.contentAdaptorRegistry.getContentAdaptorForContentType(contentType);
