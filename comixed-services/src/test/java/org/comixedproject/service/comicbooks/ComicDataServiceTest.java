...
class ComicDataServiceTest {
  ...
  @Test
  void updateComic_partial() throws ComicException, ComicException {
  ...
  @Test
  void updateComic() throws ComicException, ComicException {
    when(comicService.getByComicBookId(anyLong())).thenReturn(comic);
    when(displayableComicService.getForComicBookId(anyLong())).thenReturn(displayableComic);
    when(comicPageService.getPagesForComicBook(anyLong())).thenReturn(pageList);
    when(comicMetadataSourceService.getMetadataForComicBook(anyLong()))
  ...
  @Test
  void deleteComicBook() throws ComicException, ComicException {
    when(comicService.getByComicBookId(anyLong())).thenReturn(comic);
  ...
  @Test
  void deleteComicBooksById() throws ComicException, ComicException {
    when(comicService.getByComicBookId(anyLong())).thenReturn(comic);
  ...
  @Test
  void undeleteComicBooksById() throws ComicException, ComicException {
    when(comicService.getByComicBookId(anyLong())).thenReturn(comic);
  ...
  @Test
  void undeleteComicBook() throws ComicException, ComicException {
    when(comicService.getByComicBookId(anyLong())).thenReturn(comic);
