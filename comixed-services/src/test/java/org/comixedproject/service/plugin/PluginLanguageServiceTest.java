...
class PluginLanguageServiceTest {
  ...
  void getPluginLanguageList() {
    Mockito.when(pluginRuntimeLocator.findPluginRuntimes()).thenReturn(pluginRuntimeList);
    ...
    Mockito.verify(pluginRuntimeLocator, Mockito.times(1)).findPluginRuntimes();
  }
}
