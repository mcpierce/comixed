...
import static org.comixedproject.batch.initiators.ScrapeComicInitiator.DEFAULT_ERROR_THRESHOLD;
...
class ScrapeComicInitiatorTest {
  ...
  public void setUp()
      throws JobInstanceAlreadyCompleteException,
          ...
          JobRestartException {
    when(comicService.getBatchScrapingCount()).thenReturn(TEST_BATCH_SCRAPING_COUNT);
