...
class PublishComicSelectionStateActionTest {
  ...
  @InjectMocks private PublishComicSelectionStateAction action;
  ...
  void publish_JacksonException() throws JacksonException {
    ...
    assertThrows(PublishingException.class, () -> action.publish(comicSelectionEvent));
  }
