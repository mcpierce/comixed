...
/**
 * <code>MarkComicAsMissingGuard</code> provides a guard for marking comics a missing.
 *
...
public class MarkComicAsMissingGuard extends AbstractComicBookGuard {
  ...
  public boolean evaluate(final StateContext stateContext) {
    ...
    if (comicBook.isMissing()) {
      log.trace("Comic book already marked as missing: id={}", comicBook.getId());
      return false;
    }
